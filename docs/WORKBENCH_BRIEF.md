...
| Initial deployment | Cloud workbench: GitHub Pages + Cloudflare Worker/D1 (confirmed 2026-08-30) |
...
- Local deployment remains available for offline development; the permanent owner-facing entry is the cloud workbench.
